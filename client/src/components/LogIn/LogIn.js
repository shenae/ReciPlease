  ...
  render() {
    ...
    return (
        <div>
          ...
          {/*Main*/}
          <form className="flex-column" onSubmit={(e)=>{this.props.handleLogin(e)}}>
          <h1>Log In</h1>
          ...
          <input type={this.state.gate?"password":"text"} required="true" name="password"/>
          <label>Show Password</label>
          <input name="gate" type="checkbox" onClick={()=>{this.setState({gate:!this.state.gate})}}/>
